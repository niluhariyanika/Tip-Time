            ...
            public void onClick(View view) {
                ...
                if (!billString.equals("")) {
                    ...
                    //format the number
                     ...
                     if (peopleCount == 1) {
                         //shov the total tip
                         tv_tip_output.setText(String.format(Locale.US.getDefault(), "%.2f", tipOutput));

                         //shov the total bill including the tip
                         ...
                         tv_tip_output.setText(String.format(Locale.US.getDefault(), "%.2f", tipOutput) + " per person");
